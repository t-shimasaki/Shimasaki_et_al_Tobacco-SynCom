...
library(ggtext, quietly = T, warn.conflicts = F)
```
...
colors <- c(
  "#a7cae1", "#7095b9", "#cee8f0", "#b7e2ff", "#66a4b9",
...
colors <- data.frame(
  SynCom = c("WT_WT", "WT_ndhL", "WT_Con", "ERF_WT", "ERF_ndhL", "ERF_Con"),
...
```{r}
t <- t.test(
  x = Uni_select$unifrac[Uni_select$ID == "WT_WT-ERF_WT"],
